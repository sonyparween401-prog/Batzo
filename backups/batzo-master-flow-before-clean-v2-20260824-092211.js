...
/* ==================================================
   BATZO REAL TOUCH / CLICK BRIDGE V2
   ================================================== */

(function(){

  if(window.__BATZO_TOUCH_BRIDGE_V2__) return;
  window.__BATZO_TOUCH_BRIDGE_V2__=true;
  ...
  function findButton(words){
    ...
    const all=
      Array.from(
        document.querySelectorAll(
          "button,a,[role='button'],[role='link'],div"
        )
      );
  ...
  */
  function createTeam(){
    ...
    if(!btn){
      ...
      console.warn(
        "BATZO: CREATE TEAM BUTTON NOT FOUND"
      );
  ...
  */
  function joinContest(){
    ...
    if(
      typeof window.BATZO_JOIN_MASTER==="function"
    ){
    ...
    /*
      Fallback: activate existing Join button.
    */
    const btn=
      findButton([
        "JOIN CONTEST",
  ...
  */
  ...
  /*
    pointerdown is important for Android WebView.
  */
  document.addEventListener(
    "pointerdown",
    handlePointer,
  ...
  */
  ...
  /*
    Continuously repair dynamically-created buttons.
  */
  function repairButtons(){
    ...
    buttons.forEach(function(btn){
      ...
      if(
        ...
        /*
          Keep buttons above accidental UI overlays.
        */
        const z=
          parseInt(
            getComputedStyle(btn).zIndex || "0",
            10
          );
  ...
  console.log(
    "BATZO REAL TOUCH BRIDGE V2 READY"
  );

})();

/* ==================================================
   END TOUCH / CLICK BRIDGE
   ================================================== */
