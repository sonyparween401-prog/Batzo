...
/* BATZO_LOCAL_CRICKET_ENGINE_V3 */
(function () {
  if (typeof window === "undefined") return;
  if (window.__BATZO_LOCAL_CRICKET_ENGINE_V3__) return;

  window.__BATZO_LOCAL_CRICKET_ENGINE_V3__ = true;

  const BATZO_LOCAL_MATCHES = [
    {
      id: "batzo-live-001",
    ...
    },
    {
      ...
      state: "UPCOMING",
      format: "T20",
      venue: "Bangalore Cricket Stadium",
    ...
    if (isCricketRequest) {
      return new Response(
        JSON.stringify({
          success: true,
          status: "available",
          service: "BATZO LOCAL CRICKET ENGINE",
          matches: BATZO_LOCAL_MATCHES,
          data: BATZO_LOCAL_MATCHES,
          result: BATZO_LOCAL_MATCHES
        }),
        {
          status: 200,
          headers: {
...
/* BATZO GUARANTEED LOCAL CRICKET DATA */

const BATZO_GUARANTEED_MATCHES = [
  {
    id: "batzo-live-001",
    status: "LIVE",
    league: "BATZO PREMIER LEAGUE",
...
const BATZO_CRICKET_SERVICE = {
  ...
  status: "AVAILABLE",
  mode: "OFFLINE-FIRST",
  matches: BATZO_GUARANTEED_MATCHES
};
...
function App() {
  ...
  const [team, setTeam] = useState(BATZO_GUARANTEED_MATCHES);
