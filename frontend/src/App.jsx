...
function App() {
  ...
  const sendOtp = () => {
    ...
    setMessage('OTP sent. Enter the OTP to continue.');
    setPage('otp');
  };
  ...
  const verifyOtp = () => {
    ...
    setMessage('OTP verification screen completed. Backend OTP will be connected next.');
    setPage('profile');
  };
  ...
  if (page === 'register') {
    return (
      <AuthShell title="Create account" subtitle="Join Batzo and start your cricket journey">
        ...
        <button className="social google" onClick={() => setMessage('Google signup will be connected with OAuth.')}>
