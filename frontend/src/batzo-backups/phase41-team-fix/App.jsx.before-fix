...
(function(){
  ...
  function openCaptainEditor(team){
    ...
    document.querySelectorAll(
      ...
      btn.onclick=()=>{
        ...
        document.querySelectorAll(
          ...
          x.style.background="#222a31";
        });

        btn.style.background="#24e778";
        btn.style.color="#041009";
      };
    ...
    document.getElementById(
      ...
      if(team.captain===undefined ||
         team.captain===null){
        alert("Please select Captain.");
        return;
      }

      if(team.viceCaptain===undefined ||
         team.viceCaptain===null){
        alert("Please select Vice-Captain.");
        return;
      }
       ...
       * IMPORTANT:
       * Never use Back.
       * Never dispatch old contest handlers.
       * Direct render only.
       */
      renderContest(
        window.BATZO_ACTIVE_CONTEST ||
  ...
  /*
   * Existing Create-Team screen:
   * replace its Continue button with our own
   * reliable captain screen.
   */
