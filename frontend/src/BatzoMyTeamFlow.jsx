...
/* BATZO_MASTER_TEAM_FLOW */
(function(){
  window.addEventListener("batzo:team-confirmed",function(e){
    try{
      const team=e.detail || {};
      localStorage.setItem("batzo_last_team",JSON.stringify(team));
      localStorage.setItem("batzo_team_created","1");
    }catch(_){}
  });
})();


/* BATZO_FINAL_TEAM_STATE */
(function(){
  "use strict";
  ...
  window.addEventListener("batzo:team-confirmed",function(e){
    try{
      ...
      console.warn("BATZO TEAM STATE",err);
    }
  });
})();
